    ...
    return (
        <div className="max-w-7xl mx-auto my-10">
            ...
            <div data-aos="flip-left" data-aos-easing="ease-out-cubic"
                ...
                <div className="collapse-content">
                    <p className="font-medium">After the event has officially concluded, we will take care of delivering the prizes if necessary while all the social media accounts will be updated with post-event messaging. Finally, our project managers will conduct a thorough information gathering and analysis about the event and compile it into a post-event report that is going to be presented to you.</p>
                </div>
            </div>
        </div>
    );
